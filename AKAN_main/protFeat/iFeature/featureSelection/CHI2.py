...
def CHI2(encodings, labelFile):
	...
	if dataShape[1] != len(features):
		print('Error: inconsistent data2 shape with feature number.')
		return 0, 'Error: inconsistent data2 shape with feature number.'
	if dataShape[0] != len(labels):
		print('Error: inconsistent data2 shape with sample number.')
		return 0, 'Error: inconsistent data2 shape with sample number.'
