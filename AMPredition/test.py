...
with open('/tmp/pycharm_project_AMPPrediction/last_paper/t_proposed_prediction.txt','r') as f:
    with open('/tmp/pycharm_project_AMPPrediction/last_paper/t_proposed_prediction_copy.txt', 'w') as f2:
        for line in f:
