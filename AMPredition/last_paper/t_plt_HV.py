...
def main():
    ...
    input_fname='/tmp/pycharm_project_AMPPrediction/last_paper/t_proposed_prediction_copy.txt'
    ...
    plt.xlim(-1.5,3)
    plt.ylim(0,1)
    plt.xlabel('D1_R(mic)',fontsize=14)
    # 设置Y轴标签
    plt.ylabel('D2_R(Toxicity)',fontsize=14)
    ...
    plt.savefig('pareto'+'.png', dpi=300, bbox_inches='tight', transparent=False)
    plt.show()
