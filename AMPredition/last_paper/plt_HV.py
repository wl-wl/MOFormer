...
def main():
    ...
    input_fname='/tmp/pycharm_project_AMPPrediction/last_paper/proposed_prediction_copy.txt'
    ...
    # 设置Y轴标签
    plt.ylabel('D2_R(hemo)',fontsize=14)
    ...
    plt.savefig('pareto0'+'.png', dpi=300, bbox_inches='tight', transparent=False)
    plt.show()
