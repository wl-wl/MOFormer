...
print('所在序列坐标：')
print(sequence_index[point_x.index(max_point[0])])
print(sequence_index[point_x.index(second[0])])
print(sequence_index[point_x.index(third[0])])


plt.scatter(x,y,c=(244 / 256, 81 / 256, 96 / 256),label='Tenth Front',s=80)
plt.scatter(max_point[0],max_point[1],c='green',label='Knee Points',s=80)
...
#plt.savefig('/tmp/pycharm_project_177/knee_point-t-10.png')
plt.show()